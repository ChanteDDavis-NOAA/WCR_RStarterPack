...
Agenda <- data.frame(read_csv("./R_Workshop_Detailed_Schedule_2022.csv", col_names = FALSE))
...
```{r}
program1<-program[grepl(pattern = "Tuesday, January 12, 2021", x = Agenda0$Date), ]
...
```{r}
program1<-program[grepl(pattern = "Wednesday, January 13, 2021", x = Agenda0$Date), ]
...
```{r}
program1<-program[grepl(pattern = "Thursday, January 14, 2021", x = Agenda0$Date), ]
