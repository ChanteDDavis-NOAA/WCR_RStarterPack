...
## Course Agenda (Pacific Time) and Lessons
=======
## Course Agenda (Pacific Time) and Lessons
...
Agenda <- data.frame(read_csv("./R_Workshop_Detailed_Schedule.csv", col_names = FALSE))
...
```{r}
program1<-program[grepl(pattern = "Tuesday, January 12, 2020", x = Agenda0$Date), ]
...
```{r}
program1<-program[grepl(pattern = "Wednesday, January 13, 2020", x = Agenda0$Date), ]
...
```{r}
program1<-program[grepl(pattern = "Thursday, January 14, 2020", x = Agenda0$Date), ]
