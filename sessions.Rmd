...
```{r}
program1<-program[grepl(pattern = "Tuesday, January 5, 2020", x = Agenda0$Date), ]
...
```{r}
program1<-program[grepl(pattern = "Wednesday, January 6, 2020", x = Agenda0$Date), ]
...
```{r}
program1<-program[grepl(pattern = "Thursday, January 7, 2020", x = Agenda0$Date), ]
